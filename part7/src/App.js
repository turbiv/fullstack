...
const App = () => {
  ...
  const findAnecdoteById = (id) => anecdotes.find(anecdote => anecdote.id === id);
  ...
  return (
    <div>
      <Router>
        ...
        <Route exact path={"/anecdotes/:id"} render={({match}) => <Anecdote anecdote={findAnecdoteById(match.params.id)}/>}/>
        <Route path="/about" render={() => <About />}/>
        <Route path="/newanecdote" render={() => <NewAnecdote addNew={addNew} />}/>
        <Footer />
      </Router>
    </div>
  )
